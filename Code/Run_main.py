...
from Simulators.Simulator_electric import Simulator_electric
...
def main_f_stackelberg():
    ...
    Ag, bg, N_max, N_des, Q, p_occ_belief, avg_earning_belief, gammas = g.define_parameters(sim, fixed_params=fixed_params)
    government_performance_logger = g.Run_game_from_sim(Ag, bg, N_max, N_des, Q, p_occ_belief, avg_earning_belief, gammas, sim, fixed_params=fixed_params, plot_graphs=True, list_of_games=[1], list_of_games_to_play=[1], folder_name=name, robust_coeff=0.0, scale_param=1.0)
...
if __name__ == '__main__': 
    ...
    #find_optimal_fixed_prices(name_string, num_sample = 10, n_repetitions = 3)
